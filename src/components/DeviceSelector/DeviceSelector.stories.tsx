...
import {DeviceSelectionProps} from 'incyclist-services'
...
export const defaultArgs = {
    capability: 'control',
    devices: [
      { connectState: 'connected', deviceName: 'DCSIM FTMS .216', isSelected:true, value: 100, interface: 'wifi', onClick: fn(), onDelete: () => {} },
